...
StarField.prototype.trueRand = function( lowest, highest){
...
StarField.prototype._updateStarField = function() {
  ...
  for (i = 0; i < this.numStars; i++) {
      ...
      colIdx = this.trueRand(1,5);
      star.fillStyle = 'rgba(' + color[colIdx].join(',') + ',' + star.opacity + ')';
...
StarField.prototype._renderStarField = function() {
  ...
  for (i = 0; i < this.numStars; i++) {
      star = this.starField[i];
      this.canvas.fillStyle = star.fillStyle;
...
*/
StarField.prototype.render = function(numStars, maxStarSpeed, colors) {
...
var starField = new StarField('fullScreen').render(333, 3, colors);
  })();